-- 0007: every column of the results table can be sorted, ascending or descending.
-- sort: ends | bid | estimate | gap | name | seen   (bid_asc and bid_desc still work)
-- dir:  asc | desc   (defaults: ends and name ascending, the rest descending)
-- Lots without an estimate always sort last when sorting by estimate or headroom.
