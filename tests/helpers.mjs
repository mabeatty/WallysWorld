...
export const MIGRATION = [MIGRATION_0001, mig("0002_breadth.sql"), mig("0003_full_reads_only.sql"), mig("0004_diagnostics_and_hint.sql"), mig("0005_paged_sales.sql"), mig("0006_estimates_and_search.sql"), mig("0007_sortable_columns.sql"), mig("0008_repair_lot_urls.sql"), mig("0009_estimate_source_in_search.sql"), mig("0010_categories.sql"), mig("0011_bid_math_and_refresh.sql"), mig("0012_three_cases.sql"), mig("0013_roi.sql"), mig("0014_watch_fobs.sql")].join("\n");
