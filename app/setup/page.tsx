  ...
  return (
    <>
      <header className="top">
        <h1>Setup</h1>
        <nav className="links"><Link href="/">Dashboard</Link><Link href="/watches">Watches</Link><Link href="/collectibles">Collectibles</Link><Link href="/lots">Find lots</Link></nav>
      </header>
