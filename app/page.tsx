  ...
  return (
    <>
      ...
      <header className="top">
        ...
        <nav className="links"><Link href="/all">All items</Link><Link href={watchesHref}>Watches</Link><Link href="/collectibles">Collectibles</Link><Link href="/followed">Followed</Link><Link href="/lots">Find lots</Link><Link href="/catawiki">Catawiki</Link><Link href="/setup">Setup</Link></nav>
      </header>
