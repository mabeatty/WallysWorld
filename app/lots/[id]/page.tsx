  ...
  return (
    <>
      <header className="top">
        ...
        <nav className="links"><Link href="/">Dashboard</Link><Link href="/lots?category=Watches&sort=bid&dir=desc">Watches</Link><Link href="/lots">Find lots</Link>{l.url && <a href={l.url}>Open on EBTH</a>}</nav>
      </header>
      <p className="note">
