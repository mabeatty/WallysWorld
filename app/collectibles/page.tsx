  ...
  return (
    <>
      <header className="top">
        <h1>Collectibles</h1>
        <nav className="links"><Link href="/">Dashboard</Link><Link href="/all">All items</Link><Link href="/watches">Watches</Link><Link href="/followed">Followed</Link><Link href="/lots">Find lots</Link><Link href="/catawiki">Catawiki</Link><Link href="/setup">Setup</Link></nav>
      </header>
